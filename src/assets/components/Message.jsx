...
const Message = () => {
  return (
    <>
      <div className="message md:flex mt-6 md:mt-0 py-5 lg:py-20 px-3 md:px-28 md:gap-48 justify-center items-center">
        <div className="md:flex md:w-3/5">
          <div className="">
            ...
            <p className="text-base md:text-md leading-6 align-baseline pt-2 md:text-lg md:pt-8 md:pr-10 md:leading-8">
              ...
              doing things that matter. <br /> Take a look ate the opportunities
              you'll have at the School. The task of a modern educator is not to
